...
public partial class search : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from products where status='Published' and category_slug like '%'+@search_query+'%' or product_category like '%'+@search_query+'%' or product_name like '%'+@search_query+'%' ORDER BY sr DESC";
        SqlCommand cmd = new SqlCommand(strcon, con);
        cmd.Parameters.AddWithValue("@search_query", Request.QueryString["q"].ToString());
