<%@ Page Title="My Sale" Language="C#" MasterPageFile="~/main-user.master" AutoEventWireup="true" CodeFile="my-sale.aspx.cs" Inherits="user_my_sale" %>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">All Sales (<asp:Label ID="total_lbl" runat="server" Text="0"></asp:Label>)</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr class="border-bottom-secondary">
                                            ...
                                            <td><a href='chat?e=<%# Eval("purchased_by") %>'>Chat with buyer</a></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
