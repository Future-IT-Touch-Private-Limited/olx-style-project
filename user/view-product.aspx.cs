...
public partial class user_view_product : System.Web.UI.Page
{
    ...
    public void fillDetails()
    {
        ...
        SqlCommand myCommand = new SqlCommand("select * from products where product_by=@product_by and sr=@sr", con1);
        myCommand.Parameters.AddWithValue("@product_by", Request.Cookies["unun"].Value.ToString());
    ...
    protected void update_btn_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd2 = new SqlCommand("update products set product_name=@product_name,product_category=@product_category,category_slug=@category_slug,selling_price=@selling_price,description=@description,status=@status where product_by=@product_by and sr=@sr", con2);
    ...
    protected void deletebtn_Click(object sender, EventArgs e)
    {
        ...
        if(confirm_cb.Checked)
        {
            ...
            string deleteQuery = "DELETE FROM products WHERE product_by=@product_by and sr=@sr";
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                //{
                    ...
                    {
                        command.Parameters.AddWithValue("@product_by", Request.Cookies["unun"].Value.ToString());
