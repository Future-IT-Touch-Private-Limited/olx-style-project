<%@ Page Title="My Purchase" Language="C#" MasterPageFile="~/main-user.master" AutoEventWireup="true" CodeFile="my-purchase.aspx.cs" Inherits="user_my_purchase" %>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">All Purchases (<asp:Label ID="total_lbl" runat="server" Text="0"></asp:Label>)</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr class="border-bottom-secondary">
                                            <td class="text-center"><img class="img-30 me-2" src='../products/<%# Eval("product_image") %>'></td>
                                            ...
                                            <td><a href='chat?e=<%# Eval("product_by") %>'>Chat with Seller</a></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
