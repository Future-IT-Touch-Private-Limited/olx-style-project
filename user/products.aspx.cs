...
public partial class user_my_products : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from products where product_by=@product_by ORDER BY sr DESC";
    ...
    public void all_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from products where product_by=@product_by";
