...
public partial class user_my_purchase : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from transactions where purchased_by=@purchased_by and status='Success' ORDER BY sr DESC";
    ...
    public void all_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from transactions where purchased_by=@purchased_by and status='Success'";
