<%@ Page Title="Search Product" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="search" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-section-title-wrapper-2 mb-50">
                        ...
                        <h3 class="tp-section-title-2">Search Result</h3>
                    </div>
                </div>
            </div>
