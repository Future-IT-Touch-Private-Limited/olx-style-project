...
public partial class admin_products_sold : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from transactions where status='Sold' ORDER BY sr DESC";
    ...
    public void all_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from transactions where status='Sold'";
