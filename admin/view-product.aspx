<%@ Page Title="View Product" ValidateRequest="false" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="view-product.aspx.cs" Inherits="admin_view_product" %>
