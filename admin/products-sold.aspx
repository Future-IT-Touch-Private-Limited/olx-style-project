<%@ Page Title="Products Sold" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="products-sold.aspx.cs" Inherits="admin_products_sold" %>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr class="border-bottom-secondary">
                                            ...
                                            <td><%# Eval("product_by") %></td>
                                            <td><%# Eval("purchased_by") %></td>
