<%@ Page Title="Search by Category" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="category.aspx.cs" Inherits="category" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-section-title-wrapper-2 mb-50">
                        ...
                        <h3 class="tp-section-title-2">By Category</h3>
                    </div>
                </div>
            </div>
